...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--evolve_epoch', default=7, type=int,) # if -1, evolve at last epoch
    ...
    subparsers.add_argument('--mergable_prompts', action='store_true', help='train film')
